...
public class Alert {
    ...
    public static void showAlertDialog(final Activity activity, final Intent intent) {
        final Drawable negativeIcon = activity.getResources().getDrawable(R.drawable.ic_launcher_background);
    ...
    private static void showNotification(Activity activity, String selectedTechnology) {
        ...
        Intent notificationIntent = new Intent(activity, YourMain.class); // Replace YourMainActivity with the actual main activity class
